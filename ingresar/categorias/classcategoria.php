<?php
	...
	class Listar extends conexion{
		...
		public function MostrarDatos(){//function es metodo
			$this->consulta=$this->con->query("SELECT * FROM categorias ORDER BY idcategoria ASC");//$this->consulta es para llamar a la variable consulta- con query es para hacer consulta mysql quiere deckr q se va a hacer una consuta de una base da datos
