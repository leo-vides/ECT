      ...
      public function mostrarcuota(){
           ...
           ?>
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-danger" href="../cuotas/index.php">Cancelar Pago</a>
                    <a onclick="return confirm('&iquest; pagar cuota?');" class="btn btn-success" href="pagocuota.php?id=<?php echo $this->filas['id'];?>">Pagar cuota</a></td>
